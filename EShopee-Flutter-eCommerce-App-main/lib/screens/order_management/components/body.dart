...
import 'package:e_commerce_app_flutter/services/data_streams/order_management_stream.dart';
...
class _BodyState extends State<Body> {
  final OrderedManagementStream orderedProductsStream = OrderedManagementStream();
  ...
  Widget buildOrderedProductItem(OrderedProduct orderedProduct) {
    final colourS = orderedProduct.orderStatus == "Done" ? Colors.green :
    orderedProduct.orderStatus == "Pending" ? Colors.orangeAccent : Colors.black ;
            ...
            child: Column(
              children: [
                  ...
                  child: Text.rich(
                    TextSpan(
                      ...
                      children: [
                        ...
                        TextSpan(
                          text: orderedProduct.orderStatus,
                          style: TextStyle(
                            fontWeight: FontWeight.bold,
                          ),
                        ),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: Color.fromARGB(150, 230, 230, 255),
                    borderRadius: BorderRadius.only(
