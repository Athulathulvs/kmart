              ...
              SwipeDetector(
                ...
                child: Container(
                  ...
                  child: SizedBox(
                    ...
                    child: product.images[productImagesSwiper.currentImageIndex].toString() != null ? Image.network(
  ...
  Widget buildSmallPreview(ProductImageSwiper productImagesSwiper,
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: product.images[index].toString() != null ? Image.network(product.images[index]) : AssetImage('assets/images/glap.png') ,
      ),
    );
  }
}
