      ...
      child: FutureBuilder<Product>(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            ...
            Widget orderQuantityView = SizedBox(width: 10,);
            if(orderedProduct != null){
              orderQuantityView = orderedProduct.orderQuantity == null ? SizedBox(width: 10,)  : Text.rich(
                TextSpan(
                  text: "${orderedProduct.orderQuantity.toString()} ${product.quantityUnit}",
                  style: TextStyle(
                    color: kPrimaryColor,
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text.rich(
                        TextSpan(
                            text: "\₹${orderedProduct.orderPrice}    ",
                            style: TextStyle(
                              color: kPrimaryColor,
                              fontWeight: FontWeight.w700,
                              fontSize: 12,
