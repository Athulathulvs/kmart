...
class Product extends Model {
  ...
  static const String CERTIFICATE_KEY = "certificate";
  ...
  static const String QUANTITY_UNIT = "quantity_unit";
  ...
  factory Product.fromMap(Map<String, dynamic> map, {String id}) {
    ...
    return Product(
      ...
      certificate : (map[CERTIFICATE_KEY] ?? []).cast<String>(),
      title: map[TITLE_KEY],
  ...
  Map<String, dynamic> toUpdateMap() {
    ...
    if (certificate != null) map[CERTIFICATE_KEY] = certificate;
